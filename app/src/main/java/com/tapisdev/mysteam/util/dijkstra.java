...
public class dijkstra  {
    ...
    public FirebaseFirestore myDb = FirebaseFirestore.getInstance();
    public CollectionReference graphNodeRef = myDb.collection("graph_node");
    private Context myContext;
    LokasiSteamActivity lokasiSteamActivity;
...
//            Toast.makeText(context, "Jalur Terpendek =  "+jalur_terpendek, Toast.LENGTH_LONG).show();
    ...
    public void startDijkstra(Get_koordinat_awal_akhir objects, double latx, double lngx, String statusObject) throws JSONException {
